          ...
          <section className="space-y-6">
            ...
            <div className="h-80 w-full bg-surface-elevated/40 border border-border-subtle rounded-xl p-6 relative overflow-hidden backdrop-blur-md">
              ...
              <div className="absolute top-6 right-6 bg-surface-elevated/80 border border-border-bold p-3 rounded-lg backdrop-blur-md">
                ...
                <p className="text-body-md font-body-md">{insights?.[0]?.body ?? '+12% anticipated variance due to subscription cycles.'}</p>
              </div>
            </div>
          </section>
              ...
              <div className="p-8 font-code-block text-code-block space-y-4 min-h-[300px]">
                ...
                <div className="flex gap-4">
                    ...
                    <div className="text-secondary space-y-2">
                      <p>{insights?.[0]?.title ?? 'Processing query for Period [2024-01-01 to 2024-03-31]...'}</p>
                      <p>{insights?.[0]?.body ?? 'Scan complete. Found 42 transactions under category [Beverages/Coffee].'}</p>
                      <p className="bg-secondary/10 p-2 inline-block rounded">{insights?.[0]?.hint ?? 'TOTAL Q1 COFFEE SPEND: $542.15 (Trend: +4.2% vs Q4)'}</p>
                    </div>
                </div>
